document.addEventListener('DOMContentLoaded', () => {
    ...
    const productsData = [
        ...
        { id: 'Mix-Jucie', name: 'juice', image: 'https://via.placeholder.com/150?text=Mixed+Fruit+Jam', price_per_unit: 200, units: [{ value: 0.25, name: '250g', price: 200 }, { value: 0.5, name: '500g', price: 400 }] },
